...
/*	int yellow=2;
	...
	double *position=estimation_yellow.contour_detection(threshold_yellow,src);//height calculation
...
// red 
	...
	double *position=estimation_red.contour_detection(threshold_red,src); //height calculation
